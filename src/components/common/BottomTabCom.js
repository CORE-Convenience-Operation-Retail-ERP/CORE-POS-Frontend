...
import { BottomTabBar, FabButton, TabIcon, TabItem, TabLabel } from "../../styles/bottomTab.styles";

import { FiFileText, FiCamera, FiBarChart2, FiLogOut, FiInbox } from "react-icons/fi";
...
function BottomTabCom() {
    ...
    return (
      <>
        ...
        <FabButton onClick={() => navigate("/pos/order")}> <FiCamera /> </FabButton>
      </>
    );
  }
