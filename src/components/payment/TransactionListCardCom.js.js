    ...
    const handleRefundSubmit = () => {
      ...
      return (
        <div className="tx-card" style={{
          ...
          <p>🛒 상품: {productNames}</p>
          <p>💳 결제 수단: {paymentMethod?.toUpperCase()}</p>
          ...
          <div style={{ display: "flex", gap: "10px", marginTop: "12px" }}>
            ...
            {/* 영수증 버튼은 항상 노출 */}
            <button
              onClick={() => navigate(`/pos/receipt/${transactionId}`)}
              style={{
                flex: 1,
